# Generated by Powerlevel10k configuration wizard on 2021-07-01 at 11:24 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '~/workspace/sensat/*'                          WORK     'sensat'
    '~/workspace/async-jobs/mesh-processing/*'      WORK     'mesh'
    '~/workspace/async-jobs/pointcloud-cropper/*'   WORK     'cropper'
    '~/workspace/async-jobs/pointcloud-indexer/*'   WORK     'indexer'
    '~/workspace/async-jobs/gtiles/*'               WORK     'gtiles'
    '~/workspace/product-infra/*'                   WORK     'product-infra'
    '~/workspace/pass/*'                            WORK     'pass'
  )
  #
  #   # Styling for WORK.
  ...
  typeset -g POWERLEVEL9K_VCS_WIP_ICON="\uF425 "
  ...
  function my_git_formatter() {
    ...
    if [[ $VCS_STATUS_COMMIT_SUMMARY == (|*[^[:alnum:]])(wip|WIP)(|[^[:alnum:]]*) ]]; then
      res+=" ${modified}${(g::)POWERLEVEL9K_VCS_WIP_ICON}"
    fi
    ...
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean}${(g::)POWERLEVEL9K_VCS_COMMITS_BEHIND_ICON}${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ⇢42 if ahead of the push remote; no leading space if also behind: ⇠42⇢42.
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+="${clean}${(g::)POWERLEVEL9K_VCS_COMMITS_AHEAD_ICON}${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    # *42 if have stashes.
